...
std::vector<RDNode *>
MemorySSA::findDefinitions(RDBBlock *block,
                           const DefSite& ds) {
...
std::vector<RDNode *>
MemorySSA::findDefinitionsInBlock(RDBBlock *block,
                                  const DefSite& ds) {
...
void MemorySSA::performLvn(RDBBlock *block) {
...
static void recGatherNonPhisDefs(RDNode *phi,
                                 std::set<RDNode *>& phis,
                                 std::set<RDNode *>& ret) {
...
std::vector<RDNode *>
MemorySSA::getReachingDefinitions(RDNode *use) {
    if (use->usesUnknown())
...
std::vector<RDNode *>
MemorySSA::findAllReachingDefinitions(RDNode *from) {
...
void
MemorySSA::findAllReachingDefinitions(DefinitionsMap<RDNode>& defs,
                                      RDBBlock *from,
